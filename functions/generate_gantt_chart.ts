...
import {DailyTrips, PLANETS} from "../types/trips.ts";
...
import {END_HOUR, LABELS, START_HOUR} from "../constants/chart.ts";
...
function ganttChartConfigOptions(
    ...
    axisStartTime.setHours(START_HOUR);
    const axisEndTime = new Date(trips.on);
    axisEndTime.setHours(END_HOUR);
